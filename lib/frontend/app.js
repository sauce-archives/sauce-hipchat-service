      ...
      <li className={`aui-connect-list-item list-item-sauce-status-${job.consolidated_status}`}>
        ...
        <div className="aui-connect-list-item-description">
          <p>
            ...
            <AUIButton onClick={this.postJob}>Share</AUIButton>
          </p>
        </div>
      </li>
    );
        ...
        <Slider {...settings}>
          {
            this.images().map(image => {
              return (<div style={{ "maxWidth": "1024px", "maxHeight": "768px" }}><img src={image} style={{ "maxWidth": "1024px", "maxHeight": "768px" }}>/></div>);
            })
          }
        </Slider>
      </div>
