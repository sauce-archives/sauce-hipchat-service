...
const Rollbar = require('../../public/js/rollbar.umd.nojson.min.js').init({
        ...
        <div className="aui-connect-list-item-description">
          <p>
            <AUIButton onClick={this.showVideo}>
              <img style={{ height: '0.9em', verticalAlign: 'middle' }} src={require('../../public/img/icons/video.svg')} title="See Videos" alt="See Videos" />
            </AUIButton>
            <AUIButton onClick={this.showScreenshots}>
              <img style={{ height: '0.9em', verticalAlign: 'middle' }} src={require('../../public/img/icons/screenshot.svg')} title="See Screenshots" alt="See Screenshots" />
            </AUIButton>
            <AUIButton onClick={this.postJob}>
              <img style={{ height: '0.9em', verticalAlign: 'middle', paddingBottom: '0.1em' }} src={require('../../public/img/icons/share.svg')} title="Share with chat" alt="Share with chat" />
            </AUIButton>
          </p>
        </div>
      </li>
